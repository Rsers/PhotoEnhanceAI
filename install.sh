...
echo "• api/       - Web API service (FastAPI + Uvicorn)"
echo ""

print_status "🌐 Web API Features:"
echo "• RESTful API endpoints for image enhancement"
echo "• Async processing with progress tracking"
echo "• Web-based file upload and download"
echo "• Interactive API documentation at /docs"
echo "• Ready for web frontend integration"
echo ""
